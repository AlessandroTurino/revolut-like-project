...
const profileFields = [
  { label: 'Nome completo', value: (profile: Record<string, unknown>) => profile.name },
  { label: 'Username', value: (profile: Record<string, unknown>) => profile.preferred_username },
  { label: 'Email', value: (profile: Record<string, unknown>) => profile.email },
  { label: 'Locale', value: (profile: Record<string, unknown>) => profile.locale },
  { label: 'Soggetto (sub)', value: (_profile: Record<string, unknown>, subject: string) => subject, monospaced: true },
]
...
export function ProfilePage() {
  ...
  const profileData = auth.user?.profile ?? {}
  ...
  const subject = auth.user?.profile?.sub ?? 'N/A'
